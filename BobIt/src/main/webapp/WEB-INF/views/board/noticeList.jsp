				...
				<article id="slider">
					<div class="sliderWrap">
						<div class="board_title">
							...
							<ul class="siteMap">
							<c:choose>
								<c:when test="${sessionScope.member.memType == '관리자'}">
								<li><a href="/">home</a></li>
							...
							<table class="board_list">
								...
								<tbody class="td-cen">
									<c:forEach items="${list}" var="vo" varStatus="status">
										<tr>
											<td><a href="/board/selectNotice/${vo.boardNo}">${vo.boardNo}</a></td>
											<td><a href="/board/selectNotice/${vo.boardNo}">${vo.boardSj}</a></td>
											<td>${vo.memNick}</td>
											<td><fmt:formatDate value="${vo.boardDate}"
													pattern="yyyy-MM-dd HH:mm" /></td>
											<td><c:if test="${vo.boardAtch > 0}"><img src="/img/icon_attached_file.png"></c:if></td>
											<td class="coBtn"><a href="deleteNotice/${vo.boardNo}" class="button bt-ho coBtn1" id="btn-del">삭제</a>
												<a href="updateNotice/${vo.boardNo}" class="button bt-ho coBtn2">수정</a></td>
										</tr>
									</c:forEach>
								</tbody>
						...
						<c:if test="${sessionScope.member.memType == '관리자'}">
							<div class="bt_wrap">
								...
								<a href="insertNotice"><button type="button"

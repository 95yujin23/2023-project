	...
	<div id="wrap">
		...
		<main id="main">
			<aside id="aside">
					...
					<div class="sliderWrap">
						<div class="board_title">
							...
							<ul class="siteMap">
								...
								<li><a href="/meet/meetList">모집게시판</a></li>
							</ul>
						</div>
						
						<div class="full-item">
							<form class="formType-mt">
									<select name="sido1" id="sido1"></select> 
									<select name="gugun1" id="gugun1"></select> 
									<input type="number" name="search" value="${pager.search}" style="display: none;">
									<input type="text" name="keyword" value="${pager.keyword}" style="display: none;">
					...
					<div class="imgBoardWrap">
						<ul class="imgBoardList">
							<c:forEach var="vo" items="${list}">
								<a href="selectMeet/${vo.meetNo}"><li class="listItem">
								<div class="itemImg">
				...
				<div class="bt_wrap">	
								<a href="insertMeet"><button type="button"
										class="col3 button btn-bd">모임등록</button></a>
							</div>	
					</div>
				</div>
				</article>
